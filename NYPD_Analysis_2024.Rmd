...
The following is the first ten lines of the NYPD Shooting Incident dataset (limited to the first five columns).
...
NYPD_data_head <- head(NYPD_data, 10)
NYPD_data_head <- NYPD_data_head[,1:5]

# Create the HTML table
kable(NYPD_data_head,  caption = "Displaying the first ten lines and five columns of the data. ") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive")) %>%
  scroll_box(height = "450px", width = "100%") %>%
  add_header_above(c(" " = 1, "NYPD Data" = ncol(NYPD_data_head) - 1))
...
```{r Review of the data, echo = TRUE, message= FALSE, warning=FALSE, fig.width=7.5, fig.height=5, out.width="100%"}
...
# Create a chi-squared test for the contingency table 
